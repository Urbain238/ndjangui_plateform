...
try {
    // Utilisation de LEFT JOIN et vérification de la colonne plaidoyer_msg ou plaidoyer_parrain
                ...
                <div class="card-body p-4 p-lg-5">
                    ...
                    <?php if ($success): ?>
                        <div class="text-center py-4 animate__animated animate__bounceIn">
                            ...
                            <a href="index.php" class="btn btn-outline-primary rounded-pill px-4 mt-3">Retour à l'accueil</a>
                    ...
                    <?php elseif ($deja_vote): ?>
                        <div class="alert alert-info border-0 rounded-4 p-4 text-center">
                            ...
                            <a href="index.php" class="btn btn-sm btn-primary rounded-pill mt-2">Retour au Dashboard</a>
                        </div>
                    ...
                    <?php else: ?>
                        ...
                        <div class="plaidoyer-box mb-4">
                            ...
                            <p class="mb-0 fst-italic text-dark" style="font-size: 0.95rem;">
                                "<?php 
                                    // Affiche le plaidoyer de la notification ou celui de la table membre
                        ...
                        <form method="POST" id="voteForm">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="commentaire_vote" class="form-control bg-light border-0 rounded-4" rows="3" placeholder="Ex: Profil sérieux, je connais ce membre..."></textarea>
                            </div>
